...
task_annotations = {
    'apps.celery_app.processor.math.add': {'rate_limit': '10/m'}}
worker_prefetch_multiplier = 1

# 队列
task_queues = (
    Queue(name="math", exchange=Exchange(
        name="math", type="direct"), routing_key="math"),
    Queue(name="default", exchange=Exchange(
        name="default", type="direct"), routing_key="default")
)
